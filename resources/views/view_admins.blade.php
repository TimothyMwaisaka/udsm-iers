                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header box-header-title">
                            ...
                            <a href="{{ url('/add/admin') }}"  class="btn btn-default pull-right"><i class="fa fa-plus-circle"></i> ADD ADMIN</a>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                                ...
                                @foreach($admins as $admin)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="/list/admins/delete/{{ $admin->id }}" class="btn btn-danger btn-flat">DELETE</a>
                                        </td>
                                    </tr>
                                    </tbody>
                                @endforeach
