    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">course instructor</li>
            </ol>
        </section>
        <!-- Main content -->
                    ...
                    <div class="box">
                        ...
                        <!-- /.box-header -->
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                @foreach($instructors_courses as $instructor_course)
                                    <tbody>
                                    <tr>
                                        <td>{{ $instructor_course->instructor->firstname ." ". $instructor_course->instructor->middlename ." ". $instructor_course->instructor->lastname }}</td>
                                        <td>{{ $instructor_course->course->course_name }}</td>
                                        <td>
                                            <button type="button" class="btn btn-primary btn-flat">EDIT</button>
                                            <a href="/list/instructors-courses/delete/{{ $instructor_course->course->course_id }}"
