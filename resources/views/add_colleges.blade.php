    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">add colleges</li>
            </ol>
        </section>
                        ...
                        <form class="form-horizontal" action="" method="post" data-parsley-validate>
                            <div class="box-body">
                                ...
                                <div class="form-group{{ $errors->has('college_short_name') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="college_short_name" name="college_short_name" placeholder="eg. CoICT">
